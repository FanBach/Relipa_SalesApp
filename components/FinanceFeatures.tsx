...
export const InvoiceForm = ({ initialData, projects, clients, contracts, onBack, onSave }: any) => {
    ...
    // Dependent Dropdowns Logic & Calculation
    useEffect(() => {
        // Calculate Subtotal: Contract Value - Deduction
    ...
    // Handle Project Change -> Filter Contracts, Set Client
    const handleProjectChange = (projectId: number) => {
        ...
        setFormData(prev => ({
            ...
            contract_id: undefined // Reset contract when project changes
        }));
    };

    // Handle Contract Change -> Set Currency?
